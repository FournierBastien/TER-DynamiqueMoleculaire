...
class Univexp :
    ...
    def init(self):
        ...
        """self.x = np.ndarray(shape=(self.m), dtype=np.double)
        self.v = np.ndarray(shape=(self.m), dtype=np.double)
        self.mi = np.ndarray(shape=(self.m), dtype=np.double)
        self.ma = np.ndarray(shape=(self.m), dtype=np.double)
        self.name = np.ndarray(shape=(self.m), dtype=np.double)
